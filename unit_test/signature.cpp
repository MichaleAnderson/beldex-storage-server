...
static const auto public_key = beldex::legacy_pubkey::from_hex(
            "e35b7cf5057845284740af496ec323148db68ac2553a05e4677b96f3afdabcd1");
static const auto secret_key = beldex::legacy_seckey::from_hex(
...
TEST_CASE("signatures - it_signs_and_verifies_encoded_inputs", "[signature][...]") {
    ...
    const std::string sig_b64 = bmq::to_base64(raw_sig);
