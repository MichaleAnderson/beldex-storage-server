...
/// Stores data in this master node and forwards it to the rest of the storage swarm.  Takes keys of:
...
struct get_swarm final : endpoint {
    static constexpr auto names() { return NAMES("get_swarm", "get_mnodes_for_pubkey"); }
...
///
/// See beldexd rpc documentation (or the beldex/src/rpc/core_rpc_server_command_defs.h file) for
/// information on using these beldexd rpc endpoints.
struct beldexd_request final : endpoint {
    static constexpr auto names() { return NAMES("beldexd_request"); }
