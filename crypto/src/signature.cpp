...
extern "C" {
#include "beldex/crypto-ops/hash-ops.h"
}
...
static_assert(crypto_generichash_BYTES == beldex::HASH_SIZE, "Wrong hash size!");
...
signature signature::from_base64(std::string_view signature_b64) {
    if (!bmq::is_base64(signature_b64))
    ...
    bmq::from_base64(signature_b64.begin(), signature_b64.end(),
